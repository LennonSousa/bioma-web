...
import SharePropertyAttachments, { SharePropertyAttachment } from '../SharesPropertyAttachment';
...
export interface PropertyAttachment {
    ...
    shares: SharePropertyAttachment[];
}
            ...
            <Modal show={showModalShareIt} onHide={handleCloseModalShareIt}>
                ...
                <Formik
                    ...
                    onSubmit={async values => {
                        ...
                        try {
                            await api.post('shares/properties', {
                                email: values.email,
                                            ...
                                            <ListGroup>
                                                {
                                                    attachment.shares.map(share => {
                                                        return <SharePropertyAttachments
                                                            key={share.id}
