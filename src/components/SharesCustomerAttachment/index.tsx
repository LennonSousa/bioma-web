...
export interface ShareCustomerAttachment {
    id: string;
    email: string;
    expire_at: Date;
    activated: boolean;
...
interface ShareCustomerAttachmentsProps {
    shareAttachment: ShareCustomerAttachment;
    handleListAttachments?: () => Promise<void>;
}

const ShareCustomerAttachments: React.FC<ShareCustomerAttachmentsProps> = ({ shareAttachment, handleListAttachments }) => {
    ...
    async function deleteProduct() {
        ...
        try {
            await api.delete(`shares/customers/${shareAttachment.id}`);
            ...
            console.log("Error to delete share customer attachment");
            console.log(err);
        }
    }
...
export default ShareCustomerAttachments;