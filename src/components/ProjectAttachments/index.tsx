...
import ShareProjectAttachments, { ShareProjectAttachment } from '../SharesProjectAttachment';
...
export interface ProjectAttachment {
    ...
    order: number;
    project: Project;
    logs: LogProjectAttachment[];
    shares: ShareProjectAttachment[];
}

interface ProjectAttachmentsProps {
    attachment: ProjectAttachment;
    listAttachments?: ProjectAttachment[];
    canEdit?: boolean;
...
const ProjectAttachments: React.FC<ProjectAttachmentsProps> = ({ attachment, listAttachments, canEdit = true, handleListAttachments }) => {
            ...
            if (listAttachments) {
                ...
                list.forEach(async (item, index) => {
                    try {
                        ...
                        console.log('error to save project attachments order after deleting.');
                        console.log(err)
                    }
                });
            }
            ...
            <Modal show={showModalShareIt} onHide={handleCloseModalShareIt}>
                ...
                <Formik
                    ...
                    onSubmit={async values => {
                        ...
                        try {
                            await api.post('shares/projects', {
                                email: values.email,
                                            ...
                                            <ListGroup>
                                                {
                                                    attachment.shares.map(share => {
                                                        return <ShareProjectAttachments
                                                            key={share.id}
