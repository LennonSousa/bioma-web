...
interface LicensingStatusProps {
...
const LicensingStatusItem: React.FC<LicensingStatusProps> = ({ status, listStatus, handleListStatus }) => {
    const [showModalEditStatus, setShowModalEditStatus] = useState(false);

    const handleCloseModalEditStatus = () => {
        ...
        <ListGroup.Item variant="light">
            ...
            <Modal show={showModalEditStatus} onHide={handleCloseModalEditStatus}>
                <Modal.Header closeButton>
                    <Modal.Title>Edtiar situação</Modal.Title>
                </Modal.Header>
                <Formik
                    initialValues={
                        {
...
export default LicensingStatusItem;