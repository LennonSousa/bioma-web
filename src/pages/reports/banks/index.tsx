...
export default function Reports() {
    ...
    return (
        <>
            <NextSeo
                title="Relatórios de bancos"
                description="Relatórios de bancos da plataforma de gerenciamento da Bioma consultoria."
                openGraph={{
                    ...
                    images: [
                        {
                            ...
                            alt: 'Relatórios de bancos | Plataforma Bioma',
                        },
                        { url: 'https://app.biomaconsultoria.com/assets/images/logo-bioma.jpg' },
                    ],
                }}
