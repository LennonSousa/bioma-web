...
export default function Reports() {
    ...
    return (
        <>
            <NextSeo
                title="Relatórios de licenciamentos"
                description="Relatórios de licenciamentos da plataforma de gerenciamento da Bioma consultoria."
                openGraph={{
                    ...
                    images: [
                        {
                            ...
                            alt: 'Relatórios de licenciamentos | Plataforma Bioma',
                        },
                        { url: 'https://app.biomaconsultoria.com/assets/images/logo-bioma.jpg' },
                    ],
                }}
