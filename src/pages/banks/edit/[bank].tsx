...
export default function EditBank() {
    ...
    return (
        <>
            <NextSeo
                title="Editar banco"
                description="Editar banco da plataforma de gerenciamento da Bioma consultoria."
                openGraph={{
                    ...
                    images: [
                        {
                            ...
                            alt: 'Editar banco | Plataforma Bioma',
                        },
                        { url: 'https://app.biomaconsultoria.com/assets/images/logo-bioma.jpg' },
                    ],
                }}
                                                    ...
                                                    <Container className="content-page">
                                                        <Formik
                                                            initialValues={{
                                                                ...
                                                                sector: bankData.sector,
                                                                department: bankData.department,
                                                                phone: bankData.phone,
                                                                cellphone: bankData.cellphone,
                                                                institution: bankData.institution.id,
                                                            }}
                                                            onSubmit={async values => {
                                                                ...
                                                                try {
                                                                    await api.put(`banks/${bankData.id}`, {
                                                                    ...
                                                                    setTimeout(() => {
                                                                        router.push(`/banks/details/${bankData.id}`)
                                                                    }, 1500);
                                                                }
                                                                catch {
                                                        ...
                                                        >
                                                            {({ handleChange, handleBlur, handleSubmit, setFieldValue, values, errors, touched }) => (
                                                                <Form onSubmit={handleSubmit}>
                                                                    <Row className="mb-3">
                                                                        <Col>
                                                                            <PageBack href={`/banks/details/${bankData.id}`} subTitle="Voltar para detalhes do banco" />
                                                                        </Col>
                                                                    </Row>
