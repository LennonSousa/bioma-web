...
export default function DocsPropertyPage() {
    ...
    return (
        <>
            <NextSeo
                title="Documentos de imóveis"
                description="Documentos de imóveis da plataforma de gerenciamento da Bioma consultoria."
                openGraph={{
                    ...
                    images: [
                        {
                            ...
                            alt: 'Documentos de imóveis | Plataforma Bioma',
                        },
                        { url: 'https://app.biomaconsultoria.com/assets/images/logo-bioma.jpg' },
                    ],
                }}
