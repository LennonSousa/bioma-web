...
export default function NewCustomer() {
    ...
    function handleOnDragEnd(result: DropResult) {
        if (customerData && result.destination) {
            const from = result.source.index;
            const to = result.destination.index;

            const updatedListAttachments = produce(customerData.attachments, draft => {
                if (draft) {
            ...
            if (updatedListAttachments) {
                setCustomerData({ ...customerData, attachments: updatedListAttachments });
    ...
    async function saveOrder(list: CustomerAttachment[]) {
        list.forEach(async (item, index) => {
            try {
                ...
                console.log('error to save customer attachments order');
                console.log(err)
            }
        });
    }
                                                                                                                            ...
                                                                                                                            {(provided) => (
                                                                                                                                ...
                                                                                                                                >
                                                                                                                                    <CustomerAttachments
                                                                                                                                        ...
                                                                                                                                        listAttachments={customerData.attachments}
                                                                    ...
                                                                    initialValues={
                                                                        {
                                                                            ...
                                                                            schedule: false,
                                                                            schedule_at: 0,
                                                                            order: customerData.attachments.length,
                                                                            customer: customerData.id,
                                                                        }
                                                                    }
                                                                    onSubmit={async values => {
